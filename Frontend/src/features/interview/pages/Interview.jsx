...
const Interview = () => {
    ...
    /*
     * Fetch the selected interview plan.
     *
     * This is for loading the INTERVIEW PLAN.
     * It has nothing to do with PDF generation.
     */
    useEffect(() => {
        if (interviewId) {
    ...
    /*
     * Only this state controls the PDF loading screen.
     */
     ...
     * PDF loading screen
     *
     * This will ONLY appear when the user clicks
     * "Download Resume".
     */
    if (generatingPdf) {
        return <LoadingScreen text="GENERATING PDF" />;
    }

    /*
     * Interview plan loading screen
     *
     * This appears when opening a recent interview plan
     * until the report is loaded.
     */
    if (loading || !report) {
        return <LoadingScreen text="LOADING YOUR PLAN" />;
    }
